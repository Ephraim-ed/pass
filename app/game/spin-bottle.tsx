    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.cream2 }}>
        ...
        <View style={{ flex: 1, padding: 22 }}>
          ...
          <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            >
              ...
              <Text style={{ fontFamily: FONTS.uiBold }}>Dare</Text>. Pass the
              phone. Repeat until someone cries.
            </Text>
      ...
      {game.phase === "spin" && (
        <View style={{ flex: 1, paddingBottom: 40 }}>
          ...
          {!game.isSpinning && game.targetIndex !== null && (
            <View
              style={{ paddingHorizontal: 22, alignItems: "center", gap: 10 }}
            >
              <Text
                style={{
                  fontFamily: FONTS.mono,
          ...
          <View style={{ flexDirection: "row", gap: 12 }}>
            ...
            >
              <Svg width={14} height={14} viewBox="0 0 14 14" fill="none">
                <Path
                  d="M11 7 Q11 11 7 11 Q3 11 3 7 Q3 3 7 3 Q9.5 3 11 5"
                  stroke={COLORS.ink}
                  strokeWidth="2"
                  strokeLinecap="round"
                  fill="none"
