...
function DrawingIcon({ color }: { color: string }) {
  return (
    <Svg viewBox="0 0 64 64" width="100%" height="100%">
      ...
      />
      <Path
        d="M46 28 L54 20 L44 10 L36 18 Z"
        fill={COLORS.ink2}
        stroke={COLORS.ink}
        strokeWidth="2"
      />
